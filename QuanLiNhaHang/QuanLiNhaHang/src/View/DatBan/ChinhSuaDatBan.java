 ...
 * @author FSC
 */
public class ChinhSuaDatBan extends javax.swing.JFrame {
    DatBan datBan;
    ...
    private void backBtn_352ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtn_352ActionPerformed
        try {
            ...
            Logger.getLogger(ChinhSuaDatBan.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
    ...
    private void submitBtn_352ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtn_352ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(ChinhSuaDatBan.this, "Thêm bàn không thành công", "Lỗi", JOptionPane.ERROR_MESSAGE);
            Logger.getLogger(ChinhSuaDatBan.class.getName()).log(Level.SEVERE, null, ex);
        }
        JOptionPane.showMessageDialog(ChinhSuaDatBan.this, "Thêm bàn thành công", "Thành công", JOptionPane.PLAIN_MESSAGE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChinhSuaDatBan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChinhSuaDatBan().setVisible(true);
            }
        });
    }
