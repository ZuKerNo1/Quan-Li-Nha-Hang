    ...
    public showChartRevenue(DefaultTableModel tableShow) {
        ...
        for (int j = 0; j < tableShow.getRowCount(); j++) {
            chart.addData(new ModelChart((int) tableShow.getValueAt(j , 0) + "",
                    new double[]{
                        Double.parseDouble(fomartFloat((String) tableShow.getValueAt(j, 1))),
                    }));
        }
        chart.start();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(116, 116, 116)
                .addComponent(chart, javax.swing.GroupLayout.PREFERRED_SIZE, 700, javax.swing.GroupLayout.PREFERRED_SIZE)
